...
Handle<Value> x11ghost(const Arguments& args) {
    HandleScope scope;
    ...
    x11ghost_hash(input, output, input_len);
...
void init(Handle<Object> exports) {
    ...
    exports->Set(String::NewSymbol("x11ghost"), FunctionTemplate::New(x11ghost)->GetFunction());
}
